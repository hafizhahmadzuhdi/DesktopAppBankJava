...
public class MenuUtama extends javax.swing.JFrame {
    public Awal Awal;
    public Penarikan Penarikan;
    public InfoRekening InfoRekening;
    public SetorTunai SetorTunai;
    ...
    private void initComponents() {
        ...
        btnPembayaran.setText("SETOR TUNAI");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jPanel1, javax.swing.GroupLayout.Alignment.TRAILING, 312, 312, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
    ...
    private void btnInfoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInfoActionPerformed
        InfoRekening = new InfoRekening();
        InfoRekening.setVisible(true);
        this.dispose();
    ...
    private void btnPembayaranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPembayaranActionPerformed
        SetorTunai = new SetorTunai();
        SetorTunai.setVisible(true);
        this.dispose();
